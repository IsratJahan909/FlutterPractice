        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            tabs: [
              ...
              Tab(text: 'Tab 5', icon: Icon(Icons.account_circle_outlined)),
            ],
          ),
        ),
            ...
            child: GridView.count(
              ...
              children: [
                Container(
                  ...
                  height: 250,
                  width: 250,
                  child: Image.asset("assets/bird1.jpg"),
                ),
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/bird1.jpg"),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Center(
...
class PracticeN8 extends StatelessWidget {
  ...
  final pages2 = [
    ...
    Container(
      ...
      height: double.infinity,
      width: double.infinity,
      child: Image.asset("assets/bird2.jpg"),
    ),
    Container(
      color: Colors.teal,
      height: double.infinity,
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: SafeArea(
        child: Scaffold(body: LiquidSwipe(pages: pages2)),
      ),
    );
  }
}
